<div class="cart">
    ...
    <style>
        ...
        .modal-content {background-color:#fefefe; margin:7% auto; padding:20px; border:1px solid #888; width:80%; max-width:400px; border-radius:8px; text-align:center;}
        .swal2-container {z-index:99999 !important;}
        .close-btn {color:#aaa; float:right; font-size:28px; font-weight:bold; cursor:pointer;}
        .qr-code-area {margin:20px 0; border:1px dashed #ccc; padding:15px;}
        .btn-complete-payment {background-color:#4CAF50; color:white; padding:10px 15px; border:none; border-radius:5px; cursor:pointer; margin-top:15px;}
        .warning-text {font-size:0.8em; color:#ff0000; margin-top:5px;}
    </style>
</div>

<script src="https://cdnjs.cloudflare.com/ajax/libs/qrcodejs/1.0.0/qrcode.min.js"></script>
<!-- Thêm CSS cho Leaflet -->
<link rel="stylesheet" href="https://unpkg.com/leaflet@1.9.4/dist/leaflet.css" integrity="sha256-o0b2ZLzUgW9LJr0g5I+6uG3i30/9mT5p4L0hPZT+AA0=" crossorigin=""/>

<!-- Thêm JS cho Leaflet -->
<script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js" integrity="sha256-o0b2ZLzUgW9LJr0g5I+6uG3i30/9mT5p4L0hPZT+AA0=" crossorigin=""></script>
<script>
...
function initMap() {
    ...
    const defaultLatLng = [10.762622, 106.660172];
...
document.getElementById('paymentCompleteBtn').addEventListener('click', function() {
    ...
    paymentCompleteBtn.addEventListener('click',()=>{
        Swal.fire({title:'Thanh toán thành công!', text:`Yêu cầu thanh toán ${currentTotalAmount.toLocaleString()} ₫ đã được ghi nhận. Đơn hàng của bạn sẽ sớm được giao!`, icon:'success'});
