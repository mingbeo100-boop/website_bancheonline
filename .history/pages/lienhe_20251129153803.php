...
<script>
    document.getElementById("contactForm").addEventListener("submit", async function(e) {
        ...
        try {
            ...
            if (result.success) {
                document.getElementById("formMessage").textContent = "Gửi thành công! Chúng tôi sẽ liên hệ bạn sớm.";
                form.reset();
            } else {
                document.getElementById("formMessage").textContent = "Có lỗi xảy ra: " + result.message;
            }
        } catch (error) {
            document.getElementById("formMessage").textContent = "Có lỗi xảy ra: " + error.message;
        }
    });
</script>